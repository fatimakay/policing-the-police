...
The raw dataset was already cleaned and preprocessed into the clean_phil file. '''
clean_phil = pd.read_csv('data/clean-phil.csv') #policing data 
clean_phil['date'] = pd.to_datetime(clean_phil['date'])
clean_phil['year'] = clean_phil['date'].dt.year 

pop = pd.read_csv('data/Vital_Population_Cty.csv', index_col=0) #population data 
